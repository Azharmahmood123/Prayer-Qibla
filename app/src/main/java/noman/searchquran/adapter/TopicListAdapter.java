...
public class TopicListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TopicListAdapter.ViewHolder holder = null;
        LayoutInflater mInflater = (LayoutInflater) mContext.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);

        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.row_surah_list, null);

            holder = new TopicListAdapter.ViewHolder();
            ...
            holder = (TopicListAdapter.ViewHolder) convertView.getTag();
        }
        ...
        holder.tvVerses.setText(countSize+" Verses");
