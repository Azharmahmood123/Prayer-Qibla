package noman.searchquran.adapter;
...
public class TopicDetailListAdapter extends BaseAdapter {
    ...
    public TopicDetailListAdapter(Context context, List<TopicModel> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TopicDetailListAdapter.ViewHolder holder = null;
        LayoutInflater mInflater = (LayoutInflater) mContext.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);

        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.row_surah_list, null);

            holder = new TopicDetailListAdapter.ViewHolder();
            ...
            holder = (TopicDetailListAdapter.ViewHolder) convertView.getTag();
        }
