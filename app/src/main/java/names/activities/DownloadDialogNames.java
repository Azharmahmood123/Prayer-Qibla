...
public class DownloadDialogNames extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(checkDownloadStatus())
		{
			...
			{
				msg = getString(R.string.download_msg) + " " + getString(R.string.names_99) + "?";
				showDownloadDialog();
			}
		}
	...
	public void onDownloadSurah() {
		...
		{
			Intent serviceIntent = new Intent(DownloadDialogNames.this, ServiceDownloadNames.class);
			startService(serviceIntent);
		}
		else
		{
			Toast.makeText(DownloadDialogNames.this, R.string.toast_network_error, 0).show();
		}
