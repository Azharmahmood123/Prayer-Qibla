...
//    public static final int ALGERIAN_METHOD = 0;
//    public static final int EGYPTIAN_METHOD = 1;
//    public static final int EGYPTIAN_BIS_METHOD = 2;
//    public static final int FIXED_ISHA_METHOD = 3;
//    public static final int ISLAMIC_UNIVERSITY_KARACHI_METHOD = 4;
//    public static final int ISNA_METHOD = 5;
//    public static final int JAKIN_METHOD = 6;
//    public static final int KEMENAG_METHOD = 7;
//    public static final int MUIS_METHOD = 8;
//    public static final int MWL_METHOD = 9;
//    public static final int SHIA_ATHNA_JAFRI_METHOD = 10;
//    public static final int UAE_METHOD = 11;
//    public static final int UMM_QURAN_MAKKAH_METHOD = 12;
//    public static final int UNIVERSITY_TEHRAN_METHOD = 13;
//    public static final int CUSTOM_METHOD = 14;
    ...
    public int EgyptBis; // Egyptian General Authority of Survey Bis
    public int KEMENAG; // Egyptian General Authority of Survey Bis
    public int MUIS; // Egyptian General Authority of Survey Bis
    public int FixedIsha; // Egyptian General Authority of Survey Bis
    public int JAKIM; // Egyptian General Authority of Survey Bis
    public int Algeria; // Egyptian General Authority of Survey Bis
    ...
    public PrayTime() {
        ...
        this.setKEMENAG(8);
        this.setMUIS(9);
        this.setFixedIsha(10);
        this.setJAKIM(11);
        this.setAlgeria(12);
        this.setCustom(13); // Custom Setting
        ...
        // EgyptBis
        double[] EBisValues = {20,1,0,0,18};
        methodParams.put(Integer.valueOf(this.getEgyptBis()), EBisValues);


        // KEMENAG
        double[] KEMENAGValues = {20,1,0,0,18};
        methodParams.put(Integer.valueOf(this.getKEMENAG()), EBisValues);

        // MUIS
        double[] MUISValues = {20,1,0,0,18};
        methodParams.put(Integer.valueOf(this.getMUIS()), EBisValues);

        // FixedIsha
        double[] FixedIshaValues = {19.5,1,0,1,90};
        methodParams.put(Integer.valueOf(this.getFixedIsha()), EBisValues);

        // JAKIM
        double[] JAKIMValues = {20,1,0,0,18};
        methodParams.put(Integer.valueOf(this.getJAKIM()), EBisValues);

        // Algeria
        double[] AlgeriaValues = {18,1,0,0,17};
        methodParams.put(Integer.valueOf(this.getAlgeria()), EBisValues);
    ...
    public int detectDaylightSaving() {
        TimeZone timez = TimeZone.getDefault();
        int hoursDiff = (timez.getDSTSavings() / 1000) / 60;
        return hoursDiff;
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < prayerTimes.size(); i++) {
            ...
            Log.v("Timings", prayerNames.get(i) + " - " + prayerTimes.get(i));
        }
    }
    ...
    private void setEgyptBis(int egyptBis) {
        EgyptBis = egyptBis;
    }
    ...
    public void setKEMENAG(int KEMENAG) {
        this.KEMENAG = KEMENAG;
    }
    ...
    public void setFixedIsha(int fixedIsha) {
        FixedIsha = fixedIsha;
    }
    ...
    public void setJAKIM(int JAKIM) {
        this.JAKIM = JAKIM;
    }
